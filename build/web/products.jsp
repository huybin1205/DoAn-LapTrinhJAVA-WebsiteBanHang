...
<html>
    <head>
        <title><%= constants.Constants.STORE_NAME %>: Products</title>
        <jsp:include page="layout/script-header.jsp"></jsp:include>
        </head>
        <body class="animsition">
        <%
            ProductDAO productDAO = new ProductDAO();
            int categoryId = Constants.NULL_PARAM;
            // Check param category id
            ...
            int totalRecords = productDAO.getProductByCategory(categoryId).size();
        ...
        <jsp:include page="layout/slider.jsp"></jsp:include>
            ...
            <section class="bg0 p-t-23 p-b-130">
                <div class="container">
                    ...
                    <%
                        if (productDAO.getProductByCategory(categoryId).size() <= Constants.QUANTITY_DONT_PRODUCT) {
                    %>
                    <center>
                    ...
                    %>
                    <%
                        for (Product p : productDAO.getProductByCategory(categoryId, pages)) {
                    %>
                ...
                <div class="flex-c-m flex-w w-full p-t-38">
                    ...
                    %>
                    <a href="products.jsp?category=<%= categoryId%>&page=<%=(i + 1)%>" class="flex-c-m how-pagination1 trans-04 m-all-7 
                       <%=pages == (i + 1) ? "active-pagination1" : ""%> 
